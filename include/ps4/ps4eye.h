...
namespace ps4eye {
	...
	static int countDevices();
		...
		//Added by Joshua Girard
		//Allows writing into custom memory location to avoid double copying
		void getLastLeftVideoFrame(uint8_t * buffer);
		void getLastRightVideoFrame(uint8_t * buffer);
